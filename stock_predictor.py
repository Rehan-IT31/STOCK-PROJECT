...
st.markdown(
    """
    <p style='text-align: center; color: grey; font-size: 25px;'>
    Welcome to Stock Price Predictor - The Ultimate Stock Price Predictor </p>
    <p style='text-align: center; color: green; font-size: 20px;'>
    Disclaimer: In today’s fast-paced stock market, making informed investment decisions is crucial. 
    With the power of machine learning and advanced algorithms, Stock Price Predictor empowers investors 
    like you to predict market trends, minimize risks, and maximize returns. Whether you're an experienced 
    trader or just starting, our app is designed to give you a competitive edge.
    </p>
    """,
    unsafe_allow_html=True
)
...
try:
    ...
    st.write("Detailed error information:", str(e))
st.markdown("---")  
st.markdown("### An AI-driven stock market predictor<h3>Stock Price Predictor</h3><p>&copy;2025 saboo siddik team. All rights reserved.</p>",
